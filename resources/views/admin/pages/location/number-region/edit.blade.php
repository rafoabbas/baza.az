...
@push('breadcrumb')
    <li class="breadcrumb-item active" aria-current="page">@lang('Nömrə Regionu')</li>
@endpush
    ...
    <div class="col-6">
        <form action="{{ $action }}" class="card" method="POST">
            ...
            <div class="card-body row">
                ...
                @include('admin.common.inputs.number', [ 'col' => 6, 'label' => __('Region Code'), 'name' => 'region_code', 'value' => $item->region_code ])
            ...
            @include('admin.common.card.footer', ['route' => route('admin.number-region.index')])
        </form>
    </div>
@endsection
