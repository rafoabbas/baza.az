    ...
    <div class="col-6">
        <form action="{{ $action }}" class="card" method="POST">
            ...
            <div class="card-body row">
                ...
                @include('admin.common.inputs.textarea', [ 'col' => 12, 'label' => __('Icon'), 'name' => 'icon', 'value' => $item->icon ])
            </div>
            @include('admin.common.card.footer', ['route' => route('admin.service-group.index')])
        </form>
    </div>
@endsection
