...
<div class="logo-download-conteiner add-new-image-main logo-redact-claster acordeon-conteiner__baner-claster {{ $groupClass }}">
    ...
    <a class="card-box-user__add-ads" style="display: none;">
        <label class="custom-file-upload" for="logo-download_{{ $name }}">
            <input type="file" data-toggle="upload-logo" data-route="{{ $route }}" data-name="{{ $name }}" name="file" id="logo-download_{{ $name }}" accept="image/heic, image/png, image/jpeg, image/webp" >
...
<script>
    $(document).ready(function () {
        ...
        $('[data-toggle="upload-logo"]').on('change', function (e) {
