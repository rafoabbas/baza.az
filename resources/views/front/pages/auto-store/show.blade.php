...
@section('content')
    <section class="cart-main-info single-auto-services-store">
        <div class="general-conteiner">
            <h2 class="cart-main-info__title">ТОП Запчасти</h2>
            <div class="catalog_bread-crumbs">
                <a href="">Главная</a>
                <a href="">/ Поиск автомагазинов</a>
                <p>/ ТОП запчасти</p>
            </div>
            ...
            <div class="cart-main-info__conteiner">
                <div class="cart-main-info__body-info cart-main-info__body-info_auto-store">
                    <div class="cart-main-info__direction direction">
                        <h2 class="general-titleV2">Направление магазина</h2>
                    ...
                    <div class="cart-main-info__details details">
                        <div class="details__claster">
