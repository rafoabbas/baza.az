        ...
        <div class="general-conteiner">
            <div class="autorization-popup">
                <div class="advantages-popap__wrapper">
                    <h4 class="title_popapp">Изменить пароль</h4>
                    ...
                    <form action="" class="advantages-popap__form">
                        ...
                        <div class="advantages-popap__input-conteiner input-form-conteiner">
                            <h5 class="input-form-conteiner__title">Укажите новый пароль:</h5>
                            <div class="input-form-conteiner__claster input-form-conteiner__claster_flex input-form-conteiner__claster_pass">
                                <input type="password" class="input-form-conteiner__input" placeholder="************">
                                <div class="input-form-conteiner__change-viev-pass">
                                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="advantages-popap__input-conteiner input-form-conteiner">
                            <h5 class="input-form-conteiner__title">Повторите новый пароль:</h5>
                            <div class="input-form-conteiner__claster input-form-conteiner__claster_flex input-form-conteiner__claster_pass">
                                <input type="password" class="input-form-conteiner__input" placeholder="************">
                                <div class="input-form-conteiner__change-viev-pass">
                                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="advantages-popap__btn-conteiner">
                            <button class="btn1">Поменять пароль</button>
                        </div>
                    </form>
                </div>
            </div>
