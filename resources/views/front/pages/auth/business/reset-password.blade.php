        ...
        <div class="general-conteiner">
            <div class="autorization-popup">
                <div class="advantages-popap__wrapper">
                    ...
                    <form action="{{ route('auth.business.password.store') }}" method="post" class="advantages-popap__form">
                        @csrf
                        ...
                        <div class="advantages-popap__input-conteiner input-form-conteiner">
                            ...
                            <div
                                ...
                                <input type="password" name="password_confirmation"
                                       class="input-form-conteiner__input @error('password_confirmation') is-invalid @enderror"
                                       placeholder="************">
                                <div class="input-form-conteiner__change-viev-pass">
                                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none"
                                         xmlns="http://www.w3.org/2000/svg">
