...
@section('content')
    <section class="catalog-sto-section">
        <div class="general-conteiner">
            <h2 class="general-title">Каталог СТО</h2>
            <div class="catalog_bread-crumbs">
                <a href="">Главная</a>
                <p>/ Каталог СТО</p>
            </div>
            <div class="catalog-sto-section__conteiner">
                <div class="catalog-sto-section__main-claster">
                    ...
                    <h2 class="cart-main-info__title  sto-acordeon-title">Расширенный поиск автомобилей</h2>
                    ...
                    <div class="list-sto-conteiner">
                        <div class="list-sto-conteiner__box">
                            <h4 class="list-sto-conteiner__title">Каталог СТО по городам</h4>
                            <ul>
                                <li>
                                    <a href="">Агдаш</a>
                                    <span>10</span>
                        ...
                        <div class="list-sto-conteiner__box">
                            <h4 class="list-sto-conteiner__title">Каталог СТО по брендам</h4>
                            <ul>
                                <li>
                                    <a href="">Агдаш</a>
                                    <span>10</span>
                ...
                <aside class="advanced-car-search__sitebar-banaers">
