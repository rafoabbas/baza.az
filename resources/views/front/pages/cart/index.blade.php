...
@section('content')
    <section class="cart-main-info">
        <div class="general-conteiner">
            ...
            @php($salon = $salon ?? false)
            @includeWhen($salon, 'front.pages.partials.cars.dealership')
            <div class="cart-main-info__conteiner">
                <div class="cart-main-info__body-info">
                    <div class="cart-main-info__slider-conteiner">
                        <!-- что бы добавить пометку продано для обьявления нужно добавить клас archiv-ads блоку под этим текстом -->
                        <div class="cart-main-info__big-slider-conteiner ">
                            <div class="archiv-ads__text">Продано</div>
                            <div class="cart-main-info__big-slider" data-advantages-open="galery-photo">
                                ...
                                <div class="cart-main-info__big-slider__element open_advantages-popup" data-advantages-open="galery-photo">
                                    <img src="{{ 'assets/front/img/_src/carslider.jpg' }}" alt="">
                                </div>
                            </div>
                        </div>
                        <div class="cart-main-info__smal-slider-conteiner">
                            ...
                            <div class="btn-more-photo open_advantages-popup" data-advantages-open="galery-photo">
                    ...
                    <div class="cart-main-info__text-info">
                        <div class="cart-main-info__haracteristics">
                            <h4 class="cart-main-info__title-ul">Характеристика Mercedes-Benz GLE-Class Coupe</h4>
                            <ul class="cart-main-info__haracteristic-ul">
                                <li>
                                    <span class="har-value">Регион</span>
                                    <span class="har-var">г. Баку</span>
                                </li>
                                <li>
                                    <span class="har-value">Год</span>
                                    <span class="har-var"><a href="">2020</a></span>
                                </li>
                                <li>
                                    <span class="har-value">Марка</span>
                                    <span class="har-var"><a href="">Mersedes Benz</a></span>
                                </li>
                                <li>
                                    <span class="har-value">Модель</span>
                                    <span class="har-var"><a href="">AMG</a></span>
                                </li>
                                <li>
                                    <span class="har-value">Пробег</span>
                                    <span class="har-var">100 000 км</span>
                                </li>
                                <li>
                                    <span class="har-value">Тип кузова </span>
                                    <span class="har-var">Кроссовер</span>
                                </li>
                                <li>
                                    <span class="har-value">Объем двигателя</span>
                                    <span class="har-var">2.0</span>
                                </li>
                                <li>
                                    <span class="har-value">Мощность, л.с.</span>
                                    <span class="har-var">250</span>
                                </li>
                                <li>
                                    <span class="har-value">Тип топлива </span>
                                    <span class="har-var">Бензин</span>
                                </li>
                                <li>
                                    <span class="har-value">Цвет</span>
                                    <span class="har-var">Черный металик</span>
                                </li>
                                <li>
                                    <span class="har-value">Коробка передач</span>
                                    <span class="har-var">Автомат</span>
                                </li>
                                <li>
                                    <span class="har-value">Привод</span>
                                    <span class="har-var">Полный</span>
                                </li>
                                <li>
                                    <span class="har-value">Состояние</span>
                                    <span class="har-var">С пробегом</span>
                                </li>
                                <li>
                                    <span class="har-value">Возможен обмен </span>
                                    <span class="har-var">На авто</span>
                                </li>
                                <li>
                                    <span class="har-value">Возможность в кредит</span>
                                    <span class="har-var">Да</span>
                                </li>
                            </ul>
                        ...
                        <div class="cart-main-info__complectation">
                            <div class="complectation__box complectation__ul-big">
                                <h4 class="complectation__title">Комфорт</h4>
                                <div class="complectation__ul">
                            ...
                            <div class="complectation__box">
                                <h4 class="complectation__title">Безопасность</h4>
                                <div class="complectation__ul">
                            ...
                            <div class="complectation__box">
                                <h4 class="complectation__title">Мультимедия</h4>
                                <div class="complectation__ul">
                                    <li>Подушка безопасности (Airbag)</li>
                                    <li>Центральный замок</li>
                                    <li>Галогенные фары</li>
                            ...
                            <div class="complectation__box">
                                <h4 class="complectation__title">Другое</h4>
                                <div class="complectation__ul">
                                    <li>Тонировка стекла</li>
                                </div>
                            </div>
                        </div>
                        <div class="cart-main-info__map-conteiner">
                            <h4 class="complectation__title">Местоположение на карте</h4>
                            <div id="map3"></div>
                ...
                <aside class="catalog__filtr ads-sitebar">
