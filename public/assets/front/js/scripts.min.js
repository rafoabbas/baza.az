...
$(document).ready(function() {
 ...
 //            progresBar(allProgresValue);
    ...
    let phoneElementHtml = `<div data-id="$elemenetId" class="user-main-info__inp-info input-form-conteiner phone-company-conteiner new-phone-element">
        <div class="input-form-conteiner__claster">
            <input type="text" class="input-form-conteiner__input" name="phones[$elemenetId][phone]" placeholder="+994123602040">
        </div>
        <div class="input-form-conteiner__check-box-row">
            <div class="checkbox">
                <label class="custom-checkbox">
                    <input type="checkbox" name="phones[$elemenetId][whatsapp]">
                    <span>WhatsApp</span>
                </label>
            </div>
        </div>
        <div class="btn-add-del del-phone">
            <div class="btn-add-del__icon">
                <img src="/assets/front/img/_src/del-ic.png" alt="">
            </div>
        </div>
    </div>`;

    $('.add-phone-btn').on('click',function(){
        let phoneContainer = $(this).closest('.information-about-company__phone-conteiner');
        let phoneContent = phoneContainer.find('.information-about-company__phone-content');
        let newElementId = parseInt(phoneContent.find('.phone-company-conteiner').last().data('id')) + 1;

        let newphoneElement = phoneElementHtml.replace(/\$elemenetId/g, newElementId);
        phoneContent.append(newphoneElement);
    ...
    $('.add-location').on('click',function(){
        let locationContainer = $(this).closest('.add-more-location').find('.add-more-location-container');
        locationContainer.append(locationElementHtml);
