...
    | var. Hər birini ayrıca düzəldə bilərsiniz.
    ...
    */
    ...
    'phone' => ':attribute formatı uygun olmalıdır.',
    ...
    */
    ...
    'attributes' => [
        ...
        'email' => 'E-poçt',
        'password' => 'Şifre',
        'password_confirm' => 'Şifre tekrarlamaq',
        'enabled' => 'Aktivləşdir',
        'sorting' => 'Sıralama',
        'type' => 'Növ',
        'code' => 'Kod',
        'calling_code' => 'Zeng kodu',
        'length' => 'Uzunluq',
        'sms' => 'Sms',
        'flag' => 'Bayraq',
        'token' => 'Token',
        ...
        'queue' => 'Növbə',
        'exception' => 'İstisna',
        'fileable_type' => 'Fayl tipi',
        'load_id' => 'Yük nömrəsi',
        'status' => 'Status',
        'value' => 'Dəyər',
        'other' => 'Başqa',
        'country_id' => 'Ölkə',
        'load_status_id' => 'Yük Statusu',
        'load_type_id' => 'Yük növü',
        'load_type' => 'Yük növü',
        'phone' => 'Nömrə',
        'weight' => 'Çəki',
        'price' => 'Qiymət',
        'loading_date' => 'Yük tarixi',
        'note' => 'Qeyd',
        'address_from' => 'Hardan',
        'address_to' => 'Haraya',
        'car_brand_id' => 'Maşın markası',
        'license_plate' => 'Maşın nömrəsi',
        'height' => 'Hündürlük',
        'width' => 'Eni',
        'capacity' => 'Tutum',
        'offer_status_id' => 'Təklif statusu',
        'offer_price' => 'Təklif qiyməti',
        'tax_price' => 'Vergi qiyməti',
        'create_date' => 'Yaradılma tarixi',
        'create_time' => 'Yaradılma zamanı',
        'key' => 'Açar',
        'message' => 'Mesaj',
        'receiver' => 'Qəbul edən',
        'title' => 'Başlıq',
        ...
        'admin_id' => 'Admin',
        'transaction_status_id' => 'Əməliyyat statusu',
        'transaction_type_id' => 'Əməliyyat növü',
        'avatar' => 'Şəkil',
        'balance' => 'Balans',
        'identity_card' => 'Şəxsiyyət vəsiqəsi',
        'birthday' => 'Doğum tarixi',
        'op_loading_duration_id' => 'Yükləmə müddəti',
        'op_waiting_duration_id' => 'Gözləmə müddəti',
        'op_unload_place_id' => 'Boşaltma yeri',
        'op_payment_method_id' => 'Ödəniş növü'
    ]
